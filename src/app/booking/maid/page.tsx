  ...
  const slides = [
    {
      ...
      image: "/images/services/indian_maid_hero.png",
      badges: ["Instant On-Demand", "30-Day Guarantee"]
    },
    {
      title: "Monthly Peace Plan",
      subtitle: "Unlock priority booking and fixed schedules with our zero-disruption monthly plans.",
      image: "/images/services/house_cleaning.png",
      badges: ["100% Disruption-Free", "Priority Access"]
    }
  ];
  ...
  return (
    <div className="bg-stone-50 min-h-screen pb-20">
      ...
      <div className="container mx-auto px-4 lg:px-6 max-w-4xl">
        ...
        {step === 2 && (
          <MaidCheckoutSchedule onBack={() => setStep(1)} />
        )}
      </div>
    </div>
  );
